 ...
 * @description
 */
public class PigPlantBlock extends Block implements BlockEntityProvider, Fertilizable {
    public static final IntProperty AGE = Properties.AGE_7;

    public PigPlantBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new PigPlantBlockEntity(pos, state);
    }
