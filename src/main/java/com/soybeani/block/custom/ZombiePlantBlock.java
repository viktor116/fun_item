 ...
 * @description
 */
public class ZombiePlantBlock extends Block implements BlockEntityProvider, Fertilizable {
    public static final IntProperty AGE = Properties.AGE_7;

    public ZombiePlantBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ZombiePlantBlockEntity(pos, state);
    }
