...
public class HayBlockEntity extends AnimalEntity {

    public static final EntityType<HayBlockEntity> HAY_BLOCK = Registry.register(
            Registries.ENTITY_TYPE,
            Identifier.of(InitValue.MOD_ID, "hay_block_entity"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, HayBlockEntity::new)
    ...
    protected HayBlockEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (this.isBaby() && itemStack.isOf(Items.WHEAT)) {
    ...
    public void dropLoot(DamageSource source, boolean causedByPlayer) {
        ...
        this.dropItem(Items.HAY_BLOCK, 1);
    }
