 ...
 * @description
 */
public class TntBoatEntityRenderer extends BoatEntityRenderer{
    private static final Identifier CUSTOM_BOAT_TEXTURE = Identifier.of(InitValue.MOD_ID +":textures/entity/boat/tnt_boat.png");
    private final Map<BoatEntity.Type, Pair<Identifier, CompositeEntityModel<BoatEntity>>> texturesAndModels;

    public TntBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx,true);
    ...
    private CompositeEntityModel<BoatEntity> createModel(EntityRendererFactory.Context ctx, BoatEntity.Type type, boolean chest) {
        ...
        return type == BoatEntity.Type.BAMBOO
                ...
                : new ChestBoatEntityModel(modelPart) ;
    }
