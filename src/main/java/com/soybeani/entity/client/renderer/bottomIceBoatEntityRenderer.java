 ...
 * @description
 */
public class bottomIceBoatEntityRenderer extends BoatEntityRenderer{
    private static final Identifier CUSTOM_BOAT_TEXTURE = Identifier.of(InitValue.MOD_ID +":textures/entity/boat/bottom_ice_boat.png");
    private final Map<BoatEntity.Type, Pair<Identifier, CompositeEntityModel<BoatEntity>>> texturesAndModels;

    public bottomIceBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx,false);
