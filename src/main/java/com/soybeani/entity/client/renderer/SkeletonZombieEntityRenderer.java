...
public class SkeletonZombieEntityRenderer extends ZombieBaseEntityRenderer<SkeletonZombieEntity, ZombieEntityModel<SkeletonZombieEntity>> {
    private static final Identifier TEXTURE = InitValue.id("textures/entity/mob/skeleton_zombie.png");
    public SkeletonZombieEntityRenderer(EntityRendererFactory.Context context) {
        this(context, EntityModelLayers.ZOMBIE, EntityModelLayers.ZOMBIE_INNER_ARMOR, EntityModelLayers.ZOMBIE_OUTER_ARMOR);
    }

    public SkeletonZombieEntityRenderer(EntityRendererFactory.Context ctx, EntityModelLayer layer, EntityModelLayer legsArmorLayer, EntityModelLayer bodyArmorLayer) {
