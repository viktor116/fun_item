 ...
 * @description
 */
public class IceBoatEntityRenderer extends BoatEntityRenderer{
    private static final Identifier CUSTOM_BOAT_TEXTURE = Identifier.of(InitValue.MOD_ID +":textures/entity/boat/ice_boat.png");
    private final Map<BoatEntity.Type, Pair<Identifier, CompositeEntityModel<BoatEntity>>> texturesAndModels;

    public IceBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx,false);
