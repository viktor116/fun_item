 ...
 * @description
 */
public class PurpleLightningItem extends Item {
    public PurpleLightningItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            LightningEntity lightning = PurpleLightningEntity.PURPLE_LIGHTNING.create(world);
