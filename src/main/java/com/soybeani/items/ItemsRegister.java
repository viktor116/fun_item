...
public class ItemsRegister {
    ...
    public static final RegistryKey<StatusEffect> JING_DOU_CLOUD_EFFECT_KEY = register("jingdou_cloud_effect");
    ...
    public static final StatusEffect JING_DOU_CLOUD_EFFECT = register(new JingdouCloudEffect(),JING_DOU_CLOUD_EFFECT_KEY);
    ...
    public static final RegistryEntry<StatusEffect> JING_DOU_CLOUD_EFFECT_ENTRY = Registries.STATUS_EFFECT.getEntry(JING_DOU_CLOUD_EFFECT_KEY).orElseThrow(() -> new IllegalStateException("Jing Dou Cloud Effect not registered"));
